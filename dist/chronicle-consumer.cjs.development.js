...
var ConsumerServer = /*#__PURE__*/function () {
  ...
  function ConsumerServer(opts) {
    ...
    if (opts.async) {
      ...
      this.emitter = {
        type: 'async',
        adapter: new Emittery__default["default"]()
      };
      ...
      this.emitter = {
        type: 'sync',
        adapter: new EventEmitter__default["default"]()
      };
    }
  ...
  _proto.start = function start() {
    ...
    this.server = new WebSocket__default["default"].Server({
      host: this.wsHost,
      port: this.wsPort
    });
...
//# sourceMappingURL=chronicle-consumer.cjs.development.js.map
